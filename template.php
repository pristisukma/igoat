...
<div class="col-lg-12">
	...
	<div class="panel panel-info" >
		...
		<h5 class="panel-title" style="font-size: 31px;">Kambing Sehat, Daging Nikmat!</h5>
		</div>
    ...
    <div class="col-lg-6">
       <div class="list">
          <div>
            ...
            <h4>
              Inspeksi Kesehatan Kambing
            </h4>
            <div class="section">
              Periksa kesehatan dan mencegah terjangkitnya penyakit Botulism dan Tetanus pada kambing.
            </div>
          </div>
        </div>
    </div>
     <div class="col-lg-6">
       <div class="list">
          <div>
            ...
            <div class="section">
              Ukur dan bandingkan kesehatan kambing anda secara berkelanjutan.
            </div>
          </div>
    ...
    <br><hr>
         <div class="quote">
          ...
          <div>
            <span class="section">iGoat membantu saya dan kambing saya menjadi lebih sehat. Highly recommended.</span>
