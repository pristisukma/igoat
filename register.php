...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "register")) {
  ...
  $insertGoTo = "template.php?ref=sukses";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="col-lg-12">
	...
	<div class="panel panel-warning" style="height: 285px;">
		...
		<h5 class="panel-title" style="font-size: 31px;">Ketentuan dan Kesepakatan aplikasi iGoat</h5>
		</div>
		<div class="panel-body">
		<p><i class="icon icon-ok">
             </i>  Aplikasi ini ditunjukkan untuk kalangan peternak kambing, akademisi, ataupun orang-orang yang membutuhkan informasi terkait penyakit tetanus dan botulisme pada kambing ternak.</p>
