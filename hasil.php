...
<?php include 'inc/header3.php'; ?>
  ...
  <tr class="success">
    ...
    <div class="row">
      ...
      <div class="progress">
       <?php 
    $gejala; $status;$penanganan;
        if ($workcfbotol > $workcftetanus) {
          if ($workcfbotol < 0.5 ) {
            $gejala = "Kambing menunjukkan gejala ringan penyakit botulisme.";
            $status = "Gejala Ringan Botulism";
            $penanganan = "Gejala Ringan Botulism 1";
          } elseif ($workcfbotol < 0.8) {
            $gejala = "Kambing terkena penyakit botulisme.";
            $status = "Gejala Sedang Botulism";
            $penanganan = "Gejala Ringan Botulism 2";
          } else {
            $gejala = "Kambing terkena penyakit botulisme parah dan membutuhkan perawatan segera.";
            $status = "Gejala Berat Botulism";
            $penanganan = "1. Membersihkan luka, dibawa ke rumah sakit hewan terdekat";
            $penanganan2 = "2. Membersihkan luka, dibawa ke rumah sakit hewan terdekat";
            $penanganan3 = "3. Membersihkan luka, dibawa ke rumah sakit hewan terdekat";
          }
        }  else {
          if ($workcftetanus < 0.5) {
            $gejala = "Kambing menunjukkan gejala ringan penyakit tetanus.";
            $status = "Gejala Ringan Tetanus";
            $penanganan = "Gejala Ringan Botulism 2";

          } elseif ($workcftetanus < 0.8) {
            $gejala = "Kambing terkena penyakit tetanus.";
            $status = "Gejala Sedang Tetanus";
            $penanganan = "Gejala Ringan Botulism 2";

          } else {
            $gejala = "Kambing terkena penyakit tetanus parah dan membutuhkan perawatan segera.";
  ...
  <?php endif ?>
        ...
        <h3 class="alert alert-success">Penanganan</h3>
        <p>
          <?php echo  $penanganan; ?></br>
          <?php echo  $penanganan2; ?></br>
          <?php echo  $penanganan3; ?></br>
